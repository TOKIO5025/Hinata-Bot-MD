...
// -----------------------
// 🎀 Banner épico coqueto
// -----------------------
console.clear()
console.log(chalk.magentaBright(`
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ 💋 ${chalk.bold.redBright('HINATA-Bot ENCENDIDO, MI AMOR')} 💋
┃ 🔥 ${chalk.yellow('Listo para romper WhatsApp y causar caos coqueto')} 🔥
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
`))
console.log(chalk.cyanBright('⚡ Arrancando motores... agárrate que Hinata viene con todo ⚡\n'))
...
console.log(chalk.bold.red(`[ ℹ️ ] oo bebe Algo salio mal durante la eliminación, archivos no eliminados`))
}}
...
💖 ${chalk.magentaBright('¡YA ESTOY DENTRO, PAPITO!')} 💖
💬 ${chalk.yellowBright('Conectada a WhatsApp sin miedo y lista para la acción.')} 😏
`));
}
...
conn.welcome = `💖 Hola @user, ¿cómo estás? 😘

『Bienvenido/a a *@subject*』

Un gusto conocerte, mi amor. 🤗

_Lee las reglas si no quieres que te vuelva loco/a 🧐_

*Disfruta y pásala bien 🥳*`
conn.bye = `💔 Se fue @user... Hinata te manda besitos y seguirá traviesa 😏`
conn.spromote = `✨ Wow @user, ahora eres staff. No abuses del poder, ¿eh? 👑`
conn.sdemote = `😅 @user, ya no eres admin. Sigue siendo adorable.`
conn.sDesc = '📢 La descripción ahora dice: \n@desc'
conn.sSubject = '📝 El nombre del grupo cambió a: \n@group'
conn.sIcon = '🖼️ El icono del grupo fue actualizado.'
conn.sRevoke = '🔗 El enlace del grupo cambió: \n@revoke'
...
_quickTest()
.then(() => {
    console.log(chalk.greenBright('💎 Testeo rápido completado... todo listo para la travesura 💎'));
})
.catch(console.error)
